;(async function main() {
  ...
  const USABLE = [6, 7]
  const LINES_LIMIT_OUT = 50
  const INVENTORY_LIMIT = 3250
  const COOLDOWN = 45
  const BURNOUT = 1800
