...
* Поиск рефов и сортировка по названию и расстоянию: `Inventory` (ОПРЦ) > `Сноски`
* Пользовательские темы: Ingress [REDACTED], Ingress Prime, Чёрно-белая (`Настройки` > `Цветовая схема`)
